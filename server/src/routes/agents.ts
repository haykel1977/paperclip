...
export function agentRoutes(
  ...
  async function assertSovereignAgentModel(
    ...
    console.error("[DIAG-GUARD]", JSON.stringify({allow: process.env.PAPERCLIP_ALLOW_CLOUD_MODELS, model: adapterConfig?.model, adapterType, pathLabel, pid: process.pid}));
